...
export default function VisaStatus() {
    ...
    const { application, loading: onboardingLoading, error: onboardingError, initialized: onboardingInitialized } =
    ...
    useEffect(() => {
        if (!onboardingInitialized && !onboardingLoading) {
            dispatch(fetchOnboarding());
        }
    }, [dispatch, onboardingInitialized, onboardingLoading]);
    ...
    const documents = useMemo(() => visaCas?.documents || [], [visaCas]);
    ...
    const nextStep = visaCas?.nextStep || "Waiting for HR to approve OPT Receipt";
        ...
        <Box>
            ...
            {visaLoading && !visaCas ? (
                ...
                isF1 && (
                    <>
                        <Alert
                            severity={nextStep === "All documents have been approved" ? "success" : "info"}
                            sx={{ mb: 2 }}
                        >
                            {nextStep}
                        </Alert>
